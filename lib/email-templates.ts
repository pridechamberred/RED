...
export const EMAIL_TEMPLATES: EmailTemplateMeta[] = [
  ...
  },
  {
    id: "vous-request",
    name: "Vous request",
    description: "Invites a member to a 1:1 vous after someone proposes times and places from their profile.",
    audience: "member",
    sender: "incREDible",
    fields: [
      { key: "subject", label: "Subject line", default: `🤝 {inviterName} wants to Vous with you!` },
      { key: "eyebrow", label: "Eyebrow label", default: `You've been vous'd` },
      { key: "heading", label: "Heading", default: `{inviterName} wants to Vous with you` },
      {
        key: "intro",
        label: "Intro",
        multiline: true,
        default: `Feeling seen, {recipientFirstName}? {inviterName} would love to Vous with you. They've suggested a few times and places — pick whatever works and you're booked.`,
      },
      { key: "messageLabel", label: "Heading above their note (shown only if they left one)", default: `Their note` },
      { key: "buttonLabel", label: "Button label", default: `Pick a time` },
      { key: "footerNote", label: "Closing line", default: `See you soon! ❤️` },
    ],
    variables: [
      { token: "recipientFirstName", label: "Invitee's first name", sample: "Jordan" },
      { token: "inviterName", label: "Inviter's full name", sample: "Jamie Rivera" },
    ],
  },
  {
    id: "vous-counter",
    name: "Vous — another time suggested",
    description: "Tells the original requester that the other member proposed alternative times.",
    audience: "member",
    sender: "incREDible",
    fields: [
      {
        key: "subject",
        label: "Subject line",
        default: `🤝 {counterName} suggested another time for your Vous`,
      },
      { key: "eyebrow", label: "Eyebrow label", default: `New times proposed` },
      { key: "heading", label: "Heading", default: `{counterName} suggested another time` },
      {
        key: "intro",
        label: "Intro",
        multiline: true,
        default: `{counterName} couldn't make your proposed times and has offered some alternatives. Take a look and lock one in.`,
      },
      { key: "buttonLabel", label: "Button label", default: `View & choose a time` },
    ],
    variables: [
      { token: "recipientFirstName", label: "Recipient's first name", sample: "Jordan" },
      { token: "counterName", label: "Name of who proposed new times", sample: "Alex Chen" },
    ],
  },
  {
    id: "vous-confirmed",
    name: "Vous confirmed",
    description: "Sent to both members once a vous is agreed, with the details and an add-to-calendar link.",
    audience: "member",
    sender: "incREDible",
    fields: [
      { key: "subject", label: "Subject line", default: `🎉 Your Vous is booked!` },
      { key: "eyebrow", label: "Eyebrow label", default: `You're vous-ing` },
      { key: "heading", label: "Heading", default: `You're all set, {recipientFirstName}` },
      {
        key: "intro",
        label: "Intro (the meeting details box follows this)",
        multiline: true,
        default: `You've got a Vous with {otherName}. Here are the details — we've dropped in an add-to-calendar link too.`,
      },
      { key: "buttonLabel", label: "Button label", default: `Add to calendar` },
      { key: "footerNote", label: "Closing line", default: `Now go forth and network. ❤️` },
    ],
    variables: [
      { token: "recipientFirstName", label: "Recipient's first name", sample: "Jordan" },
      { token: "otherName", label: "The other member's full name", sample: "Alex Chen" },
    ],
  },
  {
    id: "vous-cancelled",
    name: "Vous cancelled",
    description: "Notifies the other member when a vous request or confirmed vous is cancelled.",
    audience: "member",
    sender: "incREDible",
    fields: [
      { key: "subject", label: "Subject line", default: `Your Vous with {cancellerName} was cancelled` },
      { key: "eyebrow", label: "Eyebrow label", default: `Vous cancelled` },
      { key: "heading", label: "Heading", default: `{cancellerName} cancelled your Vous` },
      {
        key: "intro",
        label: "Intro",
        multiline: true,
        default: `Hi {recipientFirstName}, just letting you know {cancellerName} has cancelled your planned Vous. No worries — you can always set up another when the time's right.`,
      },
      { key: "buttonLabel", label: "Button label", default: `Find another time` },
    ],
    variables: [
      { token: "recipientFirstName", label: "Recipient's first name", sample: "Jordan" },
      { token: "cancellerName", label: "Name of who cancelled", sample: "Jamie Rivera" },
    ],
  },
  {
    id: "referred-person",
